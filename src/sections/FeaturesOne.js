      ...
      <div className="flex flex-col lg:flex-row items-center my-20 max-w-5xl mx-auto">
        ...
        <div>
          <LineItem heading="Fire and Forget transactions">
            Our tools execute your users’ transactions for you. We processes
            these transactions quickly and efficiently so that you can focus on
            building quality.
          </LineItem>
          ...
          <LineItem heading="Low to no Gas Fees for your users">
            Our transaction optimizations mean your users will pay lower gas
            fees. Plus, we give you the option to subsidize your users’
            transactions, should you want them to pay nothing at all for gas
            fees.
          </LineItem>
        </div>
      </div>
