...
export const Footer = () => (
  <footer className="container pl-8">
    <div className="flex flex-col lg:flex-row items-center lg:items-start flex-1 justify-between py-20">
      <div className="flex flex-col flex-1 items-center text-center lg:text-left max-w-xs lg:items-start">
        <img className="mb-5" alt="logo" src={logoPng} style={{ height: 40 }} />
    ...
    <div className="flex flex-1 flex-col-reverse lg:flex-row items-center justify-between py-10">
